...
async function run() {
  try {
    ...
    // Paid a parcel with id  by get id api call --------|
    ...
    // Delete a parcel by delete api call -----------------|
    ...
    // Payment Gateway International (Stripe) Api -----------|
    ...
    // Payment Gateway International (Stripe) Api (Alt) -----------|
